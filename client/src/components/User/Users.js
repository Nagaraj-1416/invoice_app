...
import { deleteUser } from "../../actions/clientActions";
...
const Users = ({ setOpen, setCurrentId, clients }) => {
  ...
  return (
    <div>
      <Container style={{ width: "100%", marginRight: "0px" }}>
              ...
              {(rowsPerPage > 0
                ...
                <TableRow key={row._id} style={{ cursor: "pointer" }}>
                  ...
                  <TableCell style={{ ...tableStyle, width: "10px" }}>
                    <IconButton
                      onClick={async () => {
                        await dispatch(deleteUser(row._id, openSnackbar));
