...
const Invoice = () => {
  ...
  const getTotalCount = async () => {
    try {
      ...
      setInvoiceData({
        ...invoiceData,
        invoiceNumber: (Number(response.data) + 1).toString().padStart(4, "0"),
      });
    } catch (error) {
      console.error(error);
    }
        ...
        createInvoice(
          {
            ...
            invoiceNumber: `${
              invoiceData.invoiceNumber < 100
                ? Number(invoiceData.invoiceNumber).toString().padStart(4, "0")
      ...
      <form onSubmit={handleSubmit} className="mu-form">
        ...
        <div>
          <Grid
            ...
            <Grid item style={{ textAlign: "left", width: "23%" }}>
              {/*<Typography
                variant="overline"
                style={{ color: "gray" }}
                gutterBottom>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <Typography
                  variant="overline"
                  style={{ color: "gray", marginBottom: "3px" }}
                  gutterBottom>
                  Date :
                </Typography>
