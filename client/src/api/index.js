...
export const deleteUser = (id) => API.delete(`/clients/user/${id}`);
export const fetchClientsByUser = (searchQuery) =>
  API.get(`/clients/user?searchQuery=${searchQuery.search}`);
export const getusers = () => API.get(`/clients/getusers`);
export const updateUser = (id, updatedClient) =>
  API.patch(`/clients/user/${id}`, updatedClient);
